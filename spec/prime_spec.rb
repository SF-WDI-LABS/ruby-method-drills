...
# TO RUN YOUR TESTS TYPE: `rspec spec/prime_spec.rb`
...
describe "#is_prime?" do
  ...
  it "returns false for numbers that aren't positive" do
  	expect( is_prime?(-1) ).to eq false
  	expect( is_prime?(0) ).to eq false
  end

  it "returns false for other composite (nonprime) positive numbers" do
